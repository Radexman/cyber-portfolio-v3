function PrivateProjectsSection() {
  return (
    <div className="flex flex-col items-center justify-between bg-primary p-4 text-center shadow-xl transition hover:scale-105 md:items-start md:p-6 md:text-left xl:col-span-2">
